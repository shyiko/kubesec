# kubesec ![Latest Version](https://img.shields.io/badge/latest-0.3.0-blue.svg) [![Build Status](https://travis-ci.org/shyiko/kubesec.svg?branch=master)](https://travis-ci.org/shyiko/kubesec)
...
```sh
curl -sSL https://github.com/shyiko/kubesec/releases/download/0.3.0/kubesec-0.3.0-$(
